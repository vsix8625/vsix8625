...
----------------------------------------------------------------------------------------------------
vim.cmd("hi clear")
vim.g.colors_name = "neovimo"
local hi = function(name, val)
  val.cterm = val.cterm or {}
  vim.api.nvim_set_hl(0, name, val)
end

local background = "#0f1a1f"
local foreground = "#a9d5c4"

local comment = "#29332f"
local error_fg = "#000000"
local error_bg = "#dc3545"
...
hi("Boolean", { fg = "#ffc107", bold = true })
hi("Constant", { fg = "#11f4b1", bold = true })
hi("Identifier", { fg = "#5fb950" }) -- struct names , c variables
hi("Keyword", { fg = "#105414", bold = true })
hi("Operator", { fg = "#a9d5c4" })
hi("Special", { fg = "#00a974" })
hi("Delimiter", { link = "Operator" })
hi("Type", { fg = "#5fb950", bold = true })
hi("Function", { fg = "#599574" })
hi("Label", { link = "Statement" })
hi("MsgArea", { fg = "#456100" })
hi("Search", { bg = "#454100", fg = "#ffffff" })
hi("Substitute", { bg = "#ffc107", fg = "#000000" })
hi("IncSearch", { bg = "#454100", fg = "#ffffff" })
hi("CurSearch", { link = "IncSearch" })
hi("Visual", { fg = "#000000", bg = "#456100", bold = true })
...
hi("@variable", { fg = "#0a84ff", bold = true })
